...
CREATE TABLE orders (
    ...
    `status` enum('PENDING','OFFER','ACCEPTED','SEND'),
    price int,
...
Insert Into employees(username, password, phone, role_id, reg_date) VALUES("employeeResp@compnayEmail.com", "123", 1234567, 2, now());
Insert into employees(username, password, phone, role_id, reg_date) VALUES ("employeeWorker@companyEmail.com", "123", 123456, 3, now());
Insert into employees(username, password, phone, role_id, reg_date) VALUES ("Martin@companyEmail.com", "123", 123456, 1, now());

Insert Into customers(username, password, reg_date, phone) VALUES ("peter@hotmail.com", "123", now(), 123456);

Insert Into orders(height, width, `length`, slope, customerId, created_at, employeeId, `status`) VALUES (480, 670, 840, 45, 1, now(), null, "PENDING");
Insert Into orders(height, width, `length`, slope, customerId, created_at, employeeId, `status`) VALUES (980, 780, 690, 45, 1, now(), null, "PENDING");
Insert Into orders(height, width, `length`, slope, customerId, created_at, employeeId, `status`) VALUES (980, 670, 540, 45, 1, now(), null, "PENDING");
