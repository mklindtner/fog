...
public class Conf
{
	...
	//for local
	public static final String  LOGFILEPATH = "/home/mkl/" +
											  ".IntelliJIdea2017.3/system/tomcat/Unnamed_maven_fog/logs/maven_fog.txt";
	...
	private static void addHandlers() throws IOException
	{
		...
		if (Conf.ISPRODUCTION) {
			...
			FileHandler handler = new FileHandler("maven_fog-log.%u.%g.txt");
			handler.setFormatter(vsf);
			LOGGER.addHandler(handler);
		}
	}
